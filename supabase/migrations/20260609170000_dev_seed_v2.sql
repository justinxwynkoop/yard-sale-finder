-- DEV SEED (v2) — remove before any production launch.
-- Promoted from supabase/scripts/seed_test_data_v2.sql so db:push
-- can run the auth.users inserts. Idempotent (on conflict do
-- nothing); all rows tagged [seed2] for the cleanup block.
